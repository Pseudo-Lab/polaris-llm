...
with st.container():
    ...
    image_path = "./image/rolellm_logo.png"
    gif_path = "./image/roleLLM-dataset.gif"

    r2c1.image(gif_path, use_column_width=True)
    # r3c1.image(image_path, use_column_width=True)
    prompt = """
    시스템 지침: 
...
with st.container():
    ...
    image_path = "./image/geminipro.png"
    gif_path = "./image/gemini-pro-dataset.gif"

    r2c2.image(gif_path, use_column_width=True)
    # r3c2.image(image_path, use_column_width=True)
    prompt = """
